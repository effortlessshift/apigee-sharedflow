...
var CLEsoure = context.getVariable('CLELog.source');
...
if(context.getVariable("skywardsNumber"))
{
        var CSOCLogObject = {
            "event": {
                ...
                "sourceApp": context.getVariable("appProduct.AppName"),
...
if (CSOCLog == "ON" || RBALog == "ON" || CLELog == "ON") {
    ...
    var logMessageContent = '{"Identifier":' + '"' + CLEsoure + '==' + context.getVariable("apiproxy.name") + '==' + context.getVariable("currentFlowName") + '==' + context.getVariable("messageid") + '"' + ',"applicationCode":' + '"' + appCode + '"' + ',"clientTransactionId":"' + correlationId + '"' + CLELogContent + CSOCLogContent + RBALogContent + '}';
